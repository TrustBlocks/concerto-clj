...
var G__1819 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.call(null,true,G__1819)){
return instaparse.combinators_source.string_ci.call(null,s);
} else {
if(cljs.core._EQ_.call(null,false,G__1819)){
return instaparse.combinators_source.string.call(null,s);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"default","default",-1987822328),G__1819)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1819)].join('')));
...
while(true){
var temp__5823__auto__ = cljs.core.first.call(null,sq);
if(cljs.core.truth_(temp__5823__auto__)){
var c = temp__5823__auto__;
var G__1821 = c;
switch (G__1821) {
case "\\":
var temp__5823__auto____$1 = cljs.core.second.call(null,sq);
if(cljs.core.truth_(temp__5823__auto____$1)){
var c2 = temp__5823__auto____$1;
if(cljs.core._EQ_.call(null,c2,"'")){
var G__1823 = cljs.core.drop.call(null,(2),sq);
var G__1824 = cljs.core.conj.call(null,v,c2);
sq = G__1823;
v = G__1824;
continue;
} else {
var G__1825 = cljs.core.drop.call(null,(2),sq);
var G__1826 = cljs.core.conj.call(null,v,c,c2);
sq = G__1825;
v = G__1826;
continue;
}
...
break;
case "\"":
var G__1827 = cljs.core.next.call(null,sq);
var G__1828 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__1827;
v = G__1828;
continue;
...
break;
default:
var G__1829 = cljs.core.next.call(null,sq);
var G__1830 = cljs.core.conj.call(null,v,c);
sq = G__1829;
v = G__1830;
continue;
...
var read_string_STAR__1831 = cljs.core.deref.call(null,new cljs.core.Var(function(){return cljs.tools.reader.read_string_STAR_;},new cljs.core.Symbol("cljs.tools.reader","read-string*","cljs.tools.reader/read-string*",1492661621,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.tools.reader","cljs.tools.reader",-831293977,null),new cljs.core.Symbol(null,"read-string*","read-string*",1046768315,null),"/Users/tombrooke/.cljs/.aot_cache/1.12.42/D119FAD/cljs/tools/reader.cljs",(20),(1),(306),(306),cljs.core.list(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"reader","reader",1810192380,null),new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"pending-forms","pending-forms",-1225172071,null)], null)),null,(cljs.core.truth_(cljs.tools.reader.read_string_STAR_)?cljs.tools.reader.read_string_STAR_.cljs$lang$test:null)])));
instaparse.cfg.safe_read_string = (function instaparse$cfg$safe_read_string(s){
return read_string_STAR__1831.call(null,cljs.tools.reader.reader_types.string_push_back_reader.call(null,s),null,null,null);
});
/**
...
while(true){
var G__1832 = instaparse.cfg.tag.call(null,tree);
var G__1832__$1 = (((G__1832 instanceof cljs.core.Keyword))?G__1832.fqn:null);
switch (G__1832__$1) {
case "rule":
var vec__1833 = instaparse.cfg.contents.call(null,tree);
var nt = cljs.core.nth.call(null,vec__1833,(0),null);
var alt_or_ord = cljs.core.nth.call(null,vec__1833,(1),null);
...
break;
case "paren":
var G__1837 = instaparse.cfg.content.call(null,tree);
tree = G__1837;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1832__$1)].join('')));
...
while(true){
var G__1838 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__1840 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__1840;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1838__$1)].join('')));
...
var valid_nts_1845 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));
var seq__1841_1846 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));
var chunk__1842_1847 = null;
var count__1843_1848 = (0);
var i__1844_1849 = (0);
while(true){
if((i__1844_1849 < count__1843_1848)){
var nt_1850 = cljs.core._nth.call(null,chunk__1842_1847,i__1844_1849);
if(cljs.core.truth_(valid_nts_1845.call(null,nt_1850))){
} else {
instaparse.util.throw_runtime_exception.call(null,cljs.core.subs.call(null,cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_1850),(1))," occurs on the right-hand side of your grammar, but not on the left");
}


var G__1851 = seq__1841_1846;
var G__1852 = chunk__1842_1847;
var G__1853 = count__1843_1848;
var G__1854 = (i__1844_1849 + (1));
seq__1841_1846 = G__1851;
chunk__1842_1847 = G__1852;
count__1843_1848 = G__1853;
i__1844_1849 = G__1854;
continue;
} else {
var temp__5825__auto___1855 = cljs.core.seq.call(null,seq__1841_1846);
if(temp__5825__auto___1855){
var seq__1841_1856__$1 = temp__5825__auto___1855;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1841_1856__$1)){
var c__5548__auto___1857 = cljs.core.chunk_first.call(null,seq__1841_1856__$1);
var G__1858 = cljs.core.chunk_rest.call(null,seq__1841_1856__$1);
var G__1859 = c__5548__auto___1857;
var G__1860 = cljs.core.count.call(null,c__5548__auto___1857);
var G__1861 = (0);
seq__1841_1846 = G__1858;
chunk__1842_1847 = G__1859;
count__1843_1848 = G__1860;
i__1844_1849 = G__1861;
continue;
} else {
var nt_1862 = cljs.core.first.call(null,seq__1841_1856__$1);
if(cljs.core.truth_(valid_nts_1845.call(null,nt_1862))){
} else {
instaparse.util.throw_runtime_exception.call(null,cljs.core.subs.call(null,cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_1862),(1))," occurs on the right-hand side of your grammar, but not on the left");
}


var G__1863 = cljs.core.next.call(null,seq__1841_1856__$1);
var G__1864 = null;
var G__1865 = (0);
var G__1866 = (0);
seq__1841_1846 = G__1863;
chunk__1842_1847 = G__1864;
count__1843_1848 = G__1865;
i__1844_1849 = G__1866;
continue;
}
} else {
}
...
return instaparse.cfg.build_parser.call(null,spec,output_format,false);
}));

(instaparse.cfg.build_parser.cljs$core$IFn$_invoke$arity$3 = (function (spec,output_format,allow_namespaced_nts_QMARK_){
var rules = instaparse.gll.parse.call(null,(cljs.core.truth_(allow_namespaced_nts_QMARK_)?instaparse.cfg.cfg_allow_namespaced_nts:instaparse.cfg.cfg),new cljs.core.Keyword(null,"rules","rules",1198912366),spec,false);
...
var _STAR_print_newline_STAR__orig_val__1869_1874 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__1870_1875 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__1871_1876 = true;
var _STAR_print_fn_STAR__temp_val__1872_1877 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__1871_1876);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__1872_1877);

try{cljs.core.println.call(null,rules);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__1870_1875);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__1869_1874);
}
...
var len__5749__auto___1888 = arguments.length;
var i__5750__auto___1889 = (0);
while(true){
if((i__5750__auto___1889 < len__5749__auto___1888)){
args__5755__auto__.push((arguments[i__5750__auto___1889]));

var G__1890 = (i__5750__auto___1889 + (1));
i__5750__auto___1889 = G__1890;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__1880){
var map__1881 = p__1880;
var map__1881__$1 = cljs.core.__destructure_map.call(null,map__1881);
var opts = map__1881__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__1882 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__1883 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__1883);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.call(null,"Error parsing grammar specification:\n",(function (){var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__1884_1891 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__1885_1892 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__1886_1893 = true;
var _STAR_print_fn_STAR__temp_val__1887_1894 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__1886_1893);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__1887_1894);

try{cljs.core.println.call(null,rules);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__1885_1892);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__1884_1891);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})());
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__1882);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq1878){
var G__1879 = cljs.core.first.call(null,seq1878);
var seq1878__$1 = cljs.core.next.call(null,seq1878);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1879,seq1878__$1);
}));
