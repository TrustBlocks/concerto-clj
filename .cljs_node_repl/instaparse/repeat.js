...
var vec__2151 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__2151,(0),null);
var end = cljs.core.nth.call(null,vec__2151,(1),null);
...
var vec__2154 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__2154,(0),null);
var end = cljs.core.nth.call(null,vec__2154,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$.call(null,end);
} else {
...
var vec__2158 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__2158,(0),null);
var end = cljs.core.nth.call(null,vec__2158,(1),null);
...
var temp__5823__auto__ = cljs.core.seq.call(null,instaparse.repeat.parse_from_index.call(null,grammar,initial_parser,text,segment,end__$1));
...
var G__2161 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__2161;
continue;
}
...
var G__2167 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__2168 = G__2167;
var parse = cljs.core.nth.call(null,vec__2168,(0),null);
var end = cljs.core.nth.call(null,vec__2168,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__2168,(2),null);
var selection = vec__2168;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__2167__$1 = G__2167;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__2174 = G__2167__$1;
var parse__$1 = cljs.core.nth.call(null,vec__2174,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__2174,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__2174,(2),null);
var selection__$1 = vec__2174;
...
var G__2178 = cljs.core.long$.call(null,end__$1);
var G__2179 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__2180 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__2178;
parses__$1 = G__2179;
G__2167__$1 = G__2180;
continue;
...
var G__2186 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__2187 = G__2186;
var parse = cljs.core.nth.call(null,vec__2187,(0),null);
var end = cljs.core.nth.call(null,vec__2187,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__2187,(2),null);
var selection = vec__2187;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__2186__$1 = G__2186;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__2193 = G__2186__$1;
var parse__$1 = cljs.core.nth.call(null,vec__2193,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__2193,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__2193,(2),null);
var selection__$1 = vec__2193;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__2197 = cljs.core.long$.call(null,end__$1);
var G__2198 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__2199 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__2197;
parses__$1 = G__2198;
G__2186__$1 = G__2199;
continue;
...
var index__$1 = cljs.core.long$.call(null,index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__2205 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__2206 = G__2205;
var parse = cljs.core.nth.call(null,vec__2206,(0),null);
var end = cljs.core.nth.call(null,vec__2206,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__2206,(2),null);
var selection = vec__2206;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__2205__$1 = G__2205;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__2212 = G__2205__$1;
var parse__$1 = cljs.core.nth.call(null,vec__2212,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__2212,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__2212,(2),null);
var selection__$1 = vec__2212;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__2216 = cljs.core.long$.call(null,end__$1);
var G__2217 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__2218 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__2216;
parses__$1 = G__2217;
G__2205__$1 = G__2218;
continue;
...
if(cljs.core.truth_((function (){var or__5025__auto__ = cljs.core.empty_QMARK_.call(null,header_results);
if(or__5025__auto__){
...
if(cljs.core.not.call(null,(function (){var and__5023__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207));
if(and__5023__auto__){
var and__5023__auto____$1 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null).call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser));
